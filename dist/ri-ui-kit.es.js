...
function pe() {
  if (ce) return j;
  ce = 1;
  var f = Symbol.for("react.transitional.element"), _ = Symbol.for("react.fragment");
  function R(C, s, c) {
    var E = null;
...
` + J + e + ae;
    ...
    function T(e, r) {
      ...
      try {
        ...
        var n = u.DetermineComponentFrameRoot(), i = n[0], x = n[1];
        if (i && x) {
          var l = i.split(`
`), g = x.split(`
`);
...
` + l[a].replace(
        ...
        z = !1, v.H = o, c(), Error.prepareStackTrace = t;
      }
    ...
    function G(e, r, t, o, u, a) {
      ...
      if (Q.call(r, "key")) {
        ...
        o = 0 < i.length ? "{key: someKey, " + i.join(": ..., ") + ": ...}" : "{key: someKey}", fe[n + o] || (i = 0 < i.length ? "{" + i.join(": ..., ") + ": ...}" : "{}", console.error(
...
Check the top-level render call using <` + e + ">."), r;
    ...
    var _e = je, N = Symbol.for("react.transitional.element"), Te = Symbol.for("react.portal"), P = Symbol.for("react.fragment"), X = Symbol.for("react.strict_mode"), F = Symbol.for("react.profiler"), L = Symbol.for("react.consumer"), Z = Symbol.for("react.context"), Y = Symbol.for("react.forward_ref"), M = Symbol.for("react.suspense"), $ = Symbol.for("react.suspense_list"), W = Symbol.for("react.memo"), U = Symbol.for("react.lazy"), xe = Symbol.for("react.offscreen"), I = Symbol.iterator, Re = Symbol.for("react.client.reference"), v = _e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, Q = Object.prototype.hasOwnProperty, m = Object.assign, ye = Symbol.for("react.client.reference"), q = Array.isArray, y = 0, K, D, ee, re, te, ne, oe;
    C.__reactDisabledLog = !0;
    var J, ae, z = !1, V = new (typeof WeakMap == "function" ? WeakMap : Map)(), we = Symbol.for("react.client.reference"), ue, le = {}, fe = {}, se = {};
...
var ke = he();
const Oe = "_button_1esc9_1", Se = {
  button: Oe
}, Ne = ({ label: f, onClick: _ }) => /* @__PURE__ */ ke.jsx("button", { className: Se.button, onClick: _, children: f });
export {
  Ne as Button
};
